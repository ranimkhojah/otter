...
const ReactiveButton = (props: Props): JSX.Element => {
    ...
    var otterListen = "https://i.imgur.com/HGBuiyd.png"
    var otterSpeak = "https://i.imgur.com/zd5lWAl.png"
    var otterSrc = otterSpeak
    switch (true) {
    ...
    return (
        <div className="control">
            ...
            <div className="status">
                ...
                <img src={otterSrc} alt="otter" className="otter"></img>
                </button>
